...
#define I2S_BUFFER_SIZE     1024    // Audio-Buffer Größe (entsprechend dem Beispiel)

// I2S-PINS FÜR M5STACK ATOM ECHO (entsprechend dem funktionierenden Beispiel)
#define CONFIG_I2S_BCK_PIN     19  // Bit Clock
#define CONFIG_I2S_LRCK_PIN    33  // Word Select (L/R Clock)
#define CONFIG_I2S_DATA_PIN     22  // Data Out
#define CONFIG_I2S_DATA_IN_PIN  23  // Data In

// Kompatibilität mit bestehendem Code
#define I2S_MIC_BCK_PIN      CONFIG_I2S_BCK_PIN
#define I2S_MIC_WS_PIN       CONFIG_I2S_LRCK_PIN
#define I2S_MIC_DATA_PIN     CONFIG_I2S_DATA_PIN
#define I2S_MIC_DATA_IN_PIN  CONFIG_I2S_DATA_IN_PIN

#define I2S_SPEAKER_BCK_PIN  CONFIG_I2S_BCK_PIN
#define I2S_SPEAKER_WS_PIN   CONFIG_I2S_LRCK_PIN
#define I2S_SPEAKER_DATA_PIN CONFIG_I2S_DATA_PIN

// I2S-Port-Konfiguration
#define I2S_MIC_PORT        I2S_NUM_0
#define I2S_SPEAKER_PORT    I2S_NUM_1 // Wichtig: Für Mikrofon und Speaker separate Ports verwenden

// LAUTSPRECHER-VERSTÄRKER-STEUERUNG (KORRIGIERT)
...
#define AUDIO_CHUNK_SIZE    1024    // Größe der Audio-Chunks (entsprechend dem Beispiel)
#define AUDIO_RING_BUFFER_SIZE 71680 // Ring-Puffer für Audio (1024 * 70 wie im Beispiel)
#define AUDIO_SILENCE_THRESHOLD 100 // Schwellwert für Stille

// Audio-Verstärkung (entsprechend dem Beispiel)
#define AUDIO_VOLUME_GAIN   20.0f   // Verstärkungsfaktor für Mikrofon-Audio
#define AUDIO_MAX_SAMPLE    32767   // Maximaler 16-bit Sample-Wert
#define AUDIO_MIN_SAMPLE    -32768  // Minimaler 16-bit Sample-Wert

// M5Atom.h-basierte I2S-Konfiguration (entsprechend dem funktionierenden Beispiel)
